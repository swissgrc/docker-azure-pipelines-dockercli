...
|------------|------------------------------------------------------------------------------|------------------|------------|----------------|--------|------------------------------------------------------------------------------------------------------------------------------------|
| latest     | Latest stable release (from `main` branch)                                   | debian:12.7-slim | 27.3.1     | 2.29.7         | 0.17.1 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dockercli/latest?style=flat-square)   |
| unstable   | Latest unstable release (from `develop` branch)                              | debian:12.8-slim | 27.3.1     | 2.29.7         | 0.17.1 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dockercli/unstable?style=flat-square) |
...
| 27.3.0     | [Docker CLI 27.3.0](https://docs.docker.com/engine/release-notes/27.3/#2730) | debian:12.7-slim | 27.3.0     | 2.29.6         | 0.17.1 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dockercli/27.3.0?style=flat-square)   |
| 27.3.1     | [Docker CLI 27.3.1](https://docs.docker.com/engine/release-notes/27.3/#2731) | debian:12.7-slim | 27.3.1     | 2.29.1         | 0.17.1 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dockercli/27.3.1?style=flat-square)   |
