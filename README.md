...
| unstable   | Latest unstable release (from `develop` branch)                              | debian:12.7-slim | 27.2.1     | 2.29.2         | 0.16.2 | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dockercli/unstable?style=flat-square) |
